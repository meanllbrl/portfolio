...
import { BlogPost } from '@/lib/posts'; // Or Post from firestore, check types
...
interface BlogSearchProps {
    initialPosts: any[]; // Using any to avoid strict type mismatch for now, or fetch proper Post type
    allTags: string[];
}

export function BlogSearch({ initialPosts, allTags }: BlogSearchProps) {
    const t = useTranslations('blog'); // Assuming we have blog translations
            ...
            <div className="min-h-[400px]">
                {filteredPosts.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-20 px-4 border-[3px] border-dashed border-gray-300 dark:border-gray-700 rounded-3xl">
                        ...
                        <h3 className="text-2xl font-black font-heading mb-2">NOTHING HERE YET!</h3>
                        <p className="text-muted-foreground font-medium mb-6">No articles found for your search.</p>
                        <button
